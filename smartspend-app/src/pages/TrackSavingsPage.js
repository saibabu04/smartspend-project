      ...
      <main className="content bg-gray-50 min-h-screen p-6">
        <section className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8">
          ...
          <p className="text-gray-600 mb-8 text-center">
            ...
            Every penny saved brings you closer to your dreams.
          </p>
            ...
            {savingsGoals.map((goal, index) => (
              ...
              >
                <div className="flex justify-between items-center mb-3">
                  <h3 className="text-xl font-semibold text-green-700">{goal.name}</h3>
                ...
                <div className="w-full bg-gray-200 rounded-full h-4 mb-3">
                  <div
                    ...
                    style={{ width: `${progressPercentage(goal.saved, goal.target)}%` }}
                  ></div>
                </div>
                ...
                <div className="mt-4 flex gap-2">
                  ...
                  <button
                    ...
                    onClick={() => {
                      const amountInput = document.querySelectorAll('input[type="number"]')[index];
